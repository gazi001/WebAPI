...
{
    //根据活动code获取商品Getproduct_onsale_byhdcode_json返回类
    public class CodeToGoodsSuccessItem
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    public class GetCodeToGoodsResult
    {
        /// <summary>
        /// 
        /// </summary>
        public List<CodeToGoodsSuccessItem> success { get; set; }
