...
{
    //查询单个分类下商品Getproduct_onsale_bytype_json返回类
    public class ProductTypeSuccessItem
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    public class GetProductTypeResult
    {
        /// <summary>
        /// 
        /// </summary>
        public List<ProductTypeSuccessItem> success { get; set; }
